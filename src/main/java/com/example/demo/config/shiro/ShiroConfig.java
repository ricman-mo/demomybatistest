...
import com.example.demo.config.shiro.cache.CustomShiroCacheManager;
import com.example.demo.config.shiro.jwt.JwtFilter;
...
public class ShiroConfig {
  ...
  public DefaultWebSecurityManager defaultWebSecurityManager(UserRealm userRealm) {
    ...
    // 设置自定义Cache缓存
    defaultWebSecurityManager.setCacheManager(new CustomShiroCacheManager());
